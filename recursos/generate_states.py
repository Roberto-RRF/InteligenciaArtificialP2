...
def generate_full_conected_tree():
    ...
    for i in range(len(lista)):
        for j in range(len(lista)):
            if lista[i][j] == 0:
                tree[available_nodes_names[i]].append((available_nodes_names[j], 99999999))
            else: 
                tree[available_nodes_names[i]].append((available_nodes_names[j], lista[i][j]))
    ...
    for i in range(len(matris_bidireccional)):
        for j in range(len(matris_bidireccional[i])):
            if matris_bidireccional[i][j] != 0:
                bidireccional_tree[available_nodes_names[i]].append(
                    (available_nodes_names[j], matris_bidireccional[i][j]))
            if lista[i][j] != 0:
                direccional_tree[available_nodes_names[i]].append(
                    (available_nodes_names[j], lista[i][j]))
